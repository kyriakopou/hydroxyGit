...
if parpool('size') > 0, parpool close, end
...
parpool('open', clusterConfig2, 2, 'FileDependencies', {'Par.m'});
...
% Run in parallel
parpool('open', clusterConfig2, 2, 'FileDependencies', {'Par.m', 'sweepExample.m'});

% May want to use more workers
% parpool('open', clusterConfig2, 4, 'FileDependencies', {'Par.m','sweepExample.m'});
...
parpool('open', clusterConfig1, 2, 'FileDependencies', {'Par.m'});

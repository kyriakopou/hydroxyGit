function [c, ceq, gradc, gradceq] = ellipseparabolaOnlyMin(x, maxDegree, knots, ubR, t_max)
...
%     ezplot(f_b, [0 12 -1 4]);
    ...
    %symbolic solutions of the derivative (general form with 3 different possible solutions - some of them might be invalid)
...
%     ezplot(fEval_b, [0 12 -1 4]);
    ...
    gradc(:,i) = [zeros(coefBase,1); -gradsMin; zeros(numOfParams-(numOfCoef+coefBase), 1)];
